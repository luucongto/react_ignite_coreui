...
import { Button, Col, Row, Card, CardHeader, CardBody, Input, Table, FormGroup, Label, Progress } from 'reactstrap'
...
class AdminExport extends Component {
  ...
  search () {
    this.props.request({command: 'getAdmin', updated_at: this.state.updated_at, userId: this.props.userId})
  }
  _renderProducts () {
